...
export function buildComposePrompt(ctx: ConversationContext): string {
  return [
    ...
    '',
    'Compose a beautiful, personalized love poem based on the context above.',
    'IMPORTANT: Put the love poem ONLY in noteDraft — this is what appears on the notepad.',
