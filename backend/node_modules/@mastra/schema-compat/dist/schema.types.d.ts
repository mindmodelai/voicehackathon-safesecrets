...
export type PublicSchema<Output = unknown, Input = Output> = z4.ZodType<Output, Input> | z3.Schema<Output, z3.ZodTypeDef, Input> | Schema<Output> | JSONSchema7 | StandardSchemaWithJSON<Input, Output>;
