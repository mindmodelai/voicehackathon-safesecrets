...
var StepExecutor = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  async execute(params) {
    ...
    const { inputData, validationError } = await chunk4IJ4UDZX_cjs.validateStepInput({
    ...
    try {
      ...
      const stepOutput = await step.execute(
        chunk4IJ4UDZX_cjs.createDeprecationProxy(
          {
            ...
            getStepResult: chunk4IJ4UDZX_cjs.getStepResult.bind(this, stepResults),
            suspend: async (suspendPayload, suspendOptions) => {
              const { suspendData, validationError: validationError2 } = await chunk4IJ4UDZX_cjs.validateStepSuspendData({
          ...
          {
            paramName: "runCount",
            deprecationMessage: chunk4IJ4UDZX_cjs.runCountDeprecationMessage,
            logger: this.logger
          }
        )
      );
      ...
      return {
        ...
        tripwire: error instanceof chunk4IJ4UDZX_cjs.TripWire ? {
...
function createTripWireFromChunk(chunk) {
  const { payload } = chunk;
  return new chunk4IJ4UDZX_cjs.TripWire(
  ...
  if (resumeData !== void 0 && forEachIndex === void 0 && currentResult?.output?.length > 0) {
    ...
    if (suspendedIndices.length > 0) {
      ...
      for (const suspIdx of indicesToResume) {
        updatedOutput[suspIdx] = chunkBP7VYTOP_cjs.createPendingMarker();
      }
  ...
  async processWorkflowStepRun({
    ...
    if (step.step instanceof EventedWorkflow || step.step.component === "WORKFLOW") {
      if (resumeSteps?.length > 1) {
        ...
        const timeTravelParams = chunk4IJ4UDZX_cjs.createTimeTravelExecutionParams({
    ...
    const { resumeData: timeTravelResumeData, validationError: timeTravelResumeValidationError } = await chunk4IJ4UDZX_cjs.validateStepResumeData({
...
function cloneWorkflow(workflow, opts) {
  const wf = new chunk4IJ4UDZX_cjs.Workflow({
    id: opts.id,
...
function isAgent(input) {
  return input instanceof chunk4IJ4UDZX_cjs.Agent;
}
function isToolStep(input) {
  return input instanceof chunk7UWHFWST_cjs.Tool;
}
function isStepParams(input) {
  return input !== null && typeof input === "object" && "id" in input && "execute" in input && !(input instanceof chunk4IJ4UDZX_cjs.Agent) && !(input instanceof chunk7UWHFWST_cjs.Tool);
}
function isProcessor(obj) {
  return obj !== null && typeof obj === "object" && "id" in obj && typeof obj.id === "string" && !(obj instanceof chunk4IJ4UDZX_cjs.Agent) && !(obj instanceof chunk7UWHFWST_cjs.Tool) && (typeof obj.processInput === "function" || typeof obj.processInputStep === "function" || typeof obj.processOutputStream === "function" || typeof obj.processOutputResult === "function" || typeof obj.processOutputStep === "function");
}
...
function createStepFromAgent(params, agentOrToolOptions) {
  ...
  return {
    ...
    execute: async ({
      ...
      const isV2Model = chunk4IJ4UDZX_cjs.isSupportedLanguageModel(modelInfo);
...
function createStepFromProcessor(processor) {
  ...
  return {
    ...
    inputSchema: chunk4IJ4UDZX_cjs.ProcessorStepSchema,
    outputSchema: chunk4IJ4UDZX_cjs.ProcessorStepOutputSchema,
    execute: async ({ inputData, requestContext, tracingContext }) => {
      ...
      const abort = (reason, options) => {
        throw new chunk4IJ4UDZX_cjs.TripWire(reason || `Tripwire triggered by ${processor.id}`, options, processor.id);
      };
      ...
      const executePhaseWithSpan = async (fn) => {
        try {
          ...
          if (error instanceof chunk4IJ4UDZX_cjs.TripWire) {
        ...
        switch (phase) {
          case "input": {
            if (processor.processInput) {
              ...
              if (result instanceof chunkCZ4NQANZ_cjs.MessageList) {
                ...
                chunk4IJ4UDZX_cjs.ProcessorRunner.applyMessagesToMessageList(
                  result,
          ...
          case "inputStep": {
            if (processor.processInputStep) {
              ...
              const validatedResult = await chunk4IJ4UDZX_cjs.ProcessorRunner.validateAndFormatProcessInputStepResult(result, {
                messageList: passThrough.messageList,
                processor,
                stepNumber: stepNumber ?? 0
              });
...
var EventedWorkflow = class extends chunk4IJ4UDZX_cjs.Workflow {
  constructor(params) {
    super(params);
...
var EventedRun = class extends chunk4IJ4UDZX_cjs.Run {
  constructor(params) {
    super(params);
  ...
  stream({
    ...
    this.streamOutput = new chunk4IJ4UDZX_cjs.WorkflowRunOutput({
      runId: this.runId,
      workflowId: this.workflowId,
      stream
    });
...
var EventedExecutionEngine = class extends chunk4IJ4UDZX_cjs.ExecutionEngine {
  eventProcessor;
  constructor({
    mastra,
    eventProcessor,
  ...
  async execute(params) {
    ...
    const finishCb = async (event, ack) => {
      ...
      if (["workflow.end", "workflow.fail", "workflow.suspend"].includes(event.type)) {
        ...
        if (event.type === "workflow.fail" && event.data.stepResults) {
          event.data.stepResults = chunk4IJ4UDZX_cjs.hydrateSerializedStepErrors(event.data.stepResults);
        }
    ...
    for (const [stepId, stepResult] of Object.entries(stepResultsWithoutTopLevelState)) {
      cleanStepResults[stepId] = chunk4IJ4UDZX_cjs.cleanStepResult(stepResult);
    }
    let callbackArg;
...
//# sourceMappingURL=chunk-64WGYTQK.cjs.map
//# sourceMappingURL=chunk-64WGYTQK.cjs.map