...
var chunkYNNJLLFN_cjs = require('./chunk-YNNJLLFN.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkHYRYTTMT_cjs.createStreamFromGenerateResult(result)
    };
  }
...
function getStaticProvidersByGateway(name14) {
  return Object.fromEntries(Object.entries(chunkYNNJLLFN_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name14));
}
var defaultGateways = [new chunk2P6DD7M5_cjs.NetlifyGateway(), new chunkXDD5V446_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))];
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const parsed = chunkXDD5V446_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    ...
    try {
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunkXDD5V446_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkHYRYTTMT_cjs.AISDKV5LanguageModel(model);
...
async function resolveModelConfig(modelConfig, requestContext = new chunkVDKWYUGC_cjs.RequestContext(), mastra) {
  ...
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof chunkHYRYTTMT_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkHYRYTTMT_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.url) {
      ...
      const registry = chunkYNNJLLFN_cjs.GatewayRegistry.getInstance();
...
//# sourceMappingURL=chunk-VD5YA6RH.cjs.map
//# sourceMappingURL=chunk-VD5YA6RH.cjs.map