...
export declare function createStreamStep<OUTPUT = undefined>({ capabilities, runId, returnScorerData, requireToolApproval, toolCallConcurrency, resumeContext, agentId, agentName, toolCallId, methodType, saveQueueManager, memoryConfig, memory, resourceId, autoResumeSuspendedTools, workspace, }: StreamStepOptions): import("../../../workflows").Step<"stream-text-step", any, any, MastraModelOutput<OUTPUT>, unknown, unknown, import("../../../workflows").DefaultEngineType, unknown>;
export {};
