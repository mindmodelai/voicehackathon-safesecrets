...
export declare function createMapResultsStep<OUTPUT = undefined>({ capabilities, options, resourceId, runId, requestContext, memory, memoryConfig, agentSpan, agentId, methodType, }: MapResultsStepOptions<OUTPUT>): Step<string, unknown, {
