...
var getTraceStep = chunk64WGYTQK_cjs.createStep({
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunkSU5APAM6_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunk64WGYTQK_cjs.createWorkflow({
