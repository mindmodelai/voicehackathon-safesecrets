...
function isToolLoopAgentLike(obj) {
  if (!obj) return false;
  if (obj instanceof chunkVTE2OBKS_cjs.ToolLoopAgent) return true;
  ...
  async handlePrepareStep(args, currentResult) {
    if (this.settings.prepareStep) {
      ...
      if (currentResult.model) {
        const resolvedModel = await chunkVD5YA6RH_cjs.resolveModelConfig(currentResult.model);
        if (!chunk4IJ4UDZX_cjs.isSupportedLanguageModel(resolvedModel)) {
...
function toolLoopAgentToMastraAgent(agent, options) {
  ...
  return new chunk4IJ4UDZX_cjs.Agent({
    ...agentConfig,
    id,
...
//# sourceMappingURL=chunk-DBSVT6AR.cjs.map
//# sourceMappingURL=chunk-DBSVT6AR.cjs.map