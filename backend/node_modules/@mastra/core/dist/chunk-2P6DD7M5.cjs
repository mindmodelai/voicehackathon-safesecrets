...
var NetlifyGateway = class extends chunkSH4PCZ3X_cjs.MastraModelGateway {
  id = "netlify";
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      case "openai":
        return chunkSH4PCZ3X_cjs.createOpenAI({ apiKey, baseURL, headers }).responses(modelId);
      case "gemini":
      ...
      case "anthropic":
        return chunkSH4PCZ3X_cjs.createAnthropic({
          apiKey,
          baseURL: `${baseURL}/v1/`,
          headers: {
...
//# sourceMappingURL=chunk-2P6DD7M5.cjs.map
//# sourceMappingURL=chunk-2P6DD7M5.cjs.map