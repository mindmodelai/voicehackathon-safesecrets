 ...
 */
function createFullMockContext(scriptProcessor, sourceNode) {
    const bufferSources = [];
...
function fireAudioProcess(sp, length) {
    sp.onaudioprocess?.({
...
describe('AudioManager', () => {
    ...
    describe('startCapture', () => {
        it('requests microphone access', async () => {
            ...
            expect(navigator.mediaDevices.getUserMedia).toHaveBeenCalledWith(expect.objectContaining({ audio: expect.objectContaining({ channelCount: 1 }) }));
        });
...
//# sourceMappingURL=audio-manager.test.js.map